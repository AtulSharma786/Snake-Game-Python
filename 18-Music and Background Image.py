...
# background image
bgimg = pygame.image.load("photo.png")
...
def welcome():
    ...
    while not exit_game:
        ...
        text_screen("Welcome to snakes game", black, 225, 260)
        text_screen("Press space bar to play", black, 245, 300)
...
def game_loop():
    ...
    while not exit_game:
        ...
        if game_over:
            ...
            text_screen("Score: " + str(score)+"  High Score: " + str(high_score), white, 5, 5)
